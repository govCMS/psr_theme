...
function psr_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  psr_preprocess_html($variables, $hook);
  psr_preprocess_page($variables, $hook);
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function psr_preprocess_html(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function psr_preprocess_page(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function psr_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // psr_preprocess_node_page() or
  // psr_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function psr_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function psr_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function psr_preprocess_block(&$variables, $hook) {
 ...
 */
function psr_govcms_social_link($variables) {
  $title = $variables['title'];
  $output = '';

  if ($title == 'Youtube') {
    $variables['icon'] = base_path() . drupal_get_path('theme', 'psr') . '/images/youtube.png';
  }
 ...
 */
function psr_form_search_api_page_search_form_default_search_alter(&$form, &$form_state, $form_id) {
 ...
 */
function psr_preprocess_panels_pane(&$variables) {
 ...
 */
function psr_pager_link__responsive($variables) {
 ...
 */
function psr_pager_first__responsive($variables) {
  $text = $variables['text'];
  $element = $variables['element'];
  $parameters = $variables['parameters'];
 ...
 */
function psr_pager_previous__responsive($variables) {
  $text = $variables['text'];
  $element = $variables['element'];
 ...
 */
function psr_pager_next__responsive($variables) {
  $text = $variables['text'];
  $element = $variables['element'];
  $interval = $variables['interval'];
  $parameters = $variables['parameters'];
 ...
 */
function psr_pager_last__responsive($variables) {
  $text = $variables['text'];
  $element = $variables['element'];
  $parameters = $variables['parameters'];
  global $pager_page_array, $pager_total;
 ...
 */
function psr_item_list__pager($variables) {
  ...
  if (!empty($items)) {
    ...
    foreach ($items as $item) {
      ...
      if (count($children) > 0) {
        // Render nested list.
        $data .= psr_item_list__pager(array(
          'items' => $children,
          'attributes' => array(),
        ));
      }
 ...
 */
function psr_preprocess_menu_link(&$variables, $hook) {
  ...
  if (isset($variables['element']['#bid']['delta']) && $variables['element']['#bid']['delta'] == 'ctools-menu-frontpage-quicklinks-1') {
    ...
    if ($svg) {
      $svg = file_get_contents(DRUPAL_ROOT . '/' . drupal_get_path('theme', 'psr') . '/images/icons/quick-links--' . $svg . '.svg');
    }
 ...
 */
function psr_webform_element($variables) {
  $element = $variables['element'];
 ...
 */
function psr_preprocess_image_style(&$vars) {
